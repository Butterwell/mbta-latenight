...
ridership$zip[ridership$station == 'Bowdoin'] <- '02114';
ridership$zip[ridership$station == 'Boylston'] <- '02111';
ridership$zip[ridership$station == 'Braintree'] <- '02184';
ridership$zip[ridership$station == 'Broadway'] <- '02127';
ridership$zip[ridership$station == 'Central Square'] <- '02139';
ridership$zip[ridership$station == 'Charles MGH'] <- '02114';
ridership$zip[ridership$station == 'Chinatown'] <- '02111';
ridership$zip[ridership$station == 'Community College'] <- '02129';
ridership$zip[ridership$station == 'Copley Square'] <- '02116';
ridership$zip[ridership$station == 'Courthouse'] <- '02210';
ridership$zip[ridership$station == 'Davis Square'] <- '02144';
ridership$zip[ridership$station == 'Downtown Crossing'] <- '02110';
ridership$zip[ridership$station == 'Fields Corner'] <- '02122';
ridership$zip[ridership$station == 'Forest Hills'] <- '02130';
ridership$zip[ridership$station == 'Government Center'] <- '02108';
ridership$zip[ridership$station == 'Green Street'] <- '02130';
ridership$zip[ridership$station == 'Harvard'] <- '02138';
ridership$zip[ridership$station == 'Haymarket'] <- '02113';
ridership$zip[ridership$station == 'Hynes'] <- '02115';
ridership$zip[ridership$station == 'Jackson Square'] <- '02130';
ridership$zip[ridership$station == 'JFK/U Mass'] <- '02125';
ridership$zip[ridership$station == 'Kendall Square'] <- '02142';
ridership$zip[ridership$station == 'Kenmore Square'] <- '02215';
ridership$zip[ridership$station == 'Lechmere'] <- '02141';
ridership$zip[ridership$station == 'Malden Center '] <- '02148';
ridership$zip[ridership$station == 'Mass Ave'] <- '02115';
ridership$zip[ridership$station == 'Mattapan Line'] <- '02126';
ridership$zip[ridership$station == 'Maverick'] <- '02128';
ridership$zip[ridership$station == 'North Quincy'] <- '02171';
ridership$zip[ridership$station == 'North Station'] <- '02114';
ridership$zip[ridership$station == 'Oak Grove'] <- '02148';
ridership$zip[ridership$station == 'Orient Heights'] <- '02128';
ridership$zip[ridership$station == 'Park Street'] <- '02108';
ridership$zip[ridership$station == 'Porter Square'] <- '02140';
ridership$zip[ridership$station == 'Prudential'] <- '02116';
ridership$zip[ridership$station == 'Quincy Adams'] <- '02169';
ridership$zip[ridership$station == 'Quincy Center'] <- '02169';
ridership$zip[ridership$station == 'Revere Beach'] <- '02151';
ridership$zip[ridership$station == 'Riverside'] <- '02466';
ridership$zip[ridership$station == 'Roxbury Crossing'] <- '02120';
ridership$zip[ridership$station == 'Ruggles'] <- '02115';
ridership$zip[ridership$station == 'Savin Hill'] <- '02125';
ridership$zip[ridership$station == 'Science Park'] <- '02114';
ridership$zip[ridership$station == 'Shawmut'] <- '02124';
ridership$zip[ridership$station == 'South Station'] <- '02111';
ridership$zip[ridership$station == 'State Street'] <- '02108';
ridership$zip[ridership$station == 'Stony Brook'] <- '02130';
ridership$zip[ridership$station == 'Suffolk Downs'] <- '02128';
ridership$zip[ridership$station == 'Sullivan Square'] <- '02129';
ridership$zip[ridership$station == 'Symphony'] <- '02115';
ridership$zip[ridership$station == 'Tufts Medical Center'] <- '02111';
ridership$zip[ridership$station == 'Wellington '] <- '02155';
ridership$zip[ridership$station == 'Wollaston'] <- '02170';
ridership$zip[ridership$station == 'Wonderland'] <- '02151';
ridership$zip[ridership$station == 'Wood Island'] <- '02128';
ridership$zip[ridership$station == 'World Trade Center'] <- '02210';
